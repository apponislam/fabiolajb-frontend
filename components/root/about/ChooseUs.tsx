                ...
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-14">
                        ...
                        <div className="relative md:min-h-[600px]">
                            <Image src="/home/about/choseus1.svg" alt="Why cline choose us" width={445} height={375} className="w-4/5 hidden md:block"></Image>
                        ...
                        <div className="relative md:min-h-[600px]">
                            ...
                            <Image src="/home/about/choseus2.svg" alt="Why cline choose us" width={445} height={375} className="w-4/5 md:absolute bottom-0 right-0 hidden md:block" />
