            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input {...register("email")} type="email" placeholder="Enter your email address" className="w-full border border-white rounded-lg px-3 py-2 text-white bg-transparent placeholder-gray-300 focus:outline-none focus:border-[#3CB371] transition-colors" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input {...register("phone")} type="tel" placeholder="Enter your phone number" className="w-full border border-white rounded-lg px-3 py-2 text-white bg-transparent placeholder-gray-300 focus:outline-none focus:border-[#3CB371] transition-colors" />
                        {errors.phone && <p className="text-red-400 text-xs mt-1">{errors.phone.message}</p>}
                    </div>
                    <div>
                        <label className="block text-sm font-medium mb-1 text-white">Service Address</label>
                        <input {...register("address")} type="text" placeholder="Enter your service address" className="w-full border border-white rounded-lg px-3 py-2 text-white bg-transparent placeholder-gray-300 focus:outline-none focus:border-[#3CB371] transition-colors" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input {...register("businessName")} type="text" placeholder="Enter your business name" className="w-full border border-white rounded-lg px-3 py-2 text-white bg-transparent placeholder-gray-300 focus:outline-none focus:border-[#3CB371] transition-colors" />
                ...
                <div>
                    ...
                    <textarea {...register("notes")} rows={2} placeholder="Anything we should know? (Access details, priorities, special requests)" className="w-full border border-white rounded-lg px-3 py-2 text-white bg-transparent placeholder-gray-300 focus:outline-none focus:border-[#3CB371] transition-colors resize-none" />
                </div>
